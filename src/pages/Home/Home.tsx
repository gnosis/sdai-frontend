    ...
    <div className="page-home">
      ...
      <footer className="bg-[#133629] text-[#f0ebde] font-karla">
        <div className="justify-center pt-6 pb-14 flex box-border">
          <div className="justify-center pl-2.5 pr-2.5 flex w-[1240px]">
            <div className="pr-5 text-left items-center pb-0 flex w-60 min-w-[140px]">
            ...
            <div className="w-auto clear-none gap-x-8 gap-y-0 flex-row flex-grow-0 flex-shrink justify-end self-start ml-auto mr-0 pr-5 flex relative text-base items-start">
            <div className="self-start block">
                <h1 className="uppercase mt-0 text-lg mb-2.5 font-bold">
                  Organization
                </h1>
                <div className="flex-col block">
                  <div role="list" className="gap-y-2.5 flex-col justify-start flex">
                    <a role="listitem" className="w-full self-auto pl-0 float-left pr-2.5 relative flex flex-col" href="https://www.gnosis.io/validators">Validators</a>
                    <a role="listitem" className="w-full self-auto pl-0 float-left pr-2.5 relative flex flex-col" href="https://www.gnosis.io/developers">Developers</a>
                    <a role="listitem" className="w-full self-auto pl-0 float-left pr-2.5 relative flex flex-col" href="https://www.gnosis.io/community">Community</a>
                    <a role="listitem" className="w-full self-auto pl-0 float-left pr-2.5 relative flex flex-col" href="https://www.gnosis.io/blog">Blog</a>
                    <a role="listitem" className="w-full self-auto pl-0 float-left pr-2.5 relative flex flex-col" href="https://www.gnosis.io/careers">Careers</a>
                    <a role="listitem" className="w-full self-auto pl-0 float-left pr-2.5 relative flex flex-col" href="https://www.gnosis.io/about">About</a>
                  </div>
                </div>
              </div>
              <div className="self-start block">
                ...
                <div className="flex-col block">
                  <div role="list" className="gap-y-2.5 flex-col justify-start flex">
                    <a role="listitem" className="w-full self-auto pl-0 float-left pr-2.5 relative flex flex-col" href="https://docs.gnosischain.com/node/">Gnosis Docs</a>
                    <a role="listitem" className="w-full self-auto pl-0 float-left pr-2.5 relative flex flex-col" href="https://gnosisfaucet.com/">xDai Faucet</a>
                    <a role="listitem" className="w-full self-auto pl-0 float-left pr-2.5 relative flex flex-col" href="https://buyxdai.com/">Buy xDAI</a>
                    <a role="listitem" className="w-full self-auto pl-0 float-left pr-2.5 relative flex flex-col" href="https://buyxdai.com/gno">Buy GNO</a>
                    <a role="listitem" className="w-full self-auto pl-0 float-left pr-2.5 relative flex flex-col" href="https://www.gnosismetrics.com/">Gnosis Metrics</a>
                    <a role="listitem" className="w-full self-auto pl-0 float-left pr-2.5 relative flex flex-col" href="https://www.validategnosis.com/">Validate Gnosis</a>
                    <a role="listitem" className="w-full self-auto pl-0 float-left pr-2.5 relative flex flex-col" href="https://mgno.validategnosis.com/">mGNO Deposit</a>
                    <a role="listitem" className="w-full self-auto pl-0 float-left pr-2.5 relative flex flex-col" href="https://d14n.info/">d14n.info</a>
                  </div>
                </div>
              </div>
              <div className="self-start block">
                ...
                <div className="flex-col block">
                  <div role="list" className="gap-y-2.5 flex-col justify-start flex">
                    <a role="listitem" className="w-full self-auto pl-0 float-left pr-2.5 relative flex flex-col" href="https://www.daosongnosis.com/">DAO</a>
                    <a role="listitem" className="w-full self-auto pl-0 float-left pr-2.5 relative flex flex-col" href="https://www.gnosisdefi.com/">DeFi</a>
                    <a role="listitem" className="w-full self-auto pl-0 float-left pr-2.5 relative flex flex-col" href="https://www.gnosiswallets.com/">Wallet Finder</a>
                  </div>
                </div>
              </div>
              <div className="self-start block">
                ...
                <div className="flex-row justify-start flex max-w-full relative overflow-visible">
                  <div role="list" className="block">
                    <div role="listitem" className="float-left pl-2 pr-2 relative block">
                      <a href="https://twitter.com/gnosischain" target="_blank">
                    ...
                    <div role="listitem" className="float-left pl-1 pr-1 relative block">
                      <a href="https://discord.gg/xW3X5EreBM" target="_blank">
                    ...
                    <div role="listitem" className="float-left pl-1 pr-1 relative block">
                      <a href="https://gnosischain.substack.com/" target="_blank">
              ...
              <div className="self-start block">
                <div className="flex-col block">
                  <div role="list" className="gap-y-2.5 flex-col justify-start flex">
                    <a role="listitem" className="w-full self-auto pl-0 float-left pr-2.5 relative flex flex-col" href="https://www.gnosis.io/privacy-policy">Privacy Policy</a>
                    <a role="listitem" className="w-full self-auto pl-0 float-left pr-2.5 relative flex flex-col" href="https://www.gnosis.io/terms-conditions">Terms & Conditions</a>
                    <a role="listitem" className="w-full self-auto pl-0 float-left pr-2.5 relative flex flex-col" href="https://www.gnosis.io/cookie-policy">Cookie Policy</a>
                  </div>
                </div>
              </div>
            </div>
